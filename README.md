...
2. Put your `credentials.json` (Google Service Account) in the same folder
3. Run `launcher.exe`
...
### ⚠️ Important Notes
- This exe is protected with Enigma Protector. Some antivirus (especially Windows Defender) may show a warning.  
  **This is a common false positive** with protected Python apps. Please allow it if you trust us.
